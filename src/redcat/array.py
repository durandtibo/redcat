...
class BatchedArray(np.lib.mixins.NDArrayOperatorsMixin):  # (BaseBatch[ndarray]):
    ...
    def batch_dim(self) -> int:
        r"""The batch dimension in the ``numpy.ndarray`` object."""
    ...
    def shape(self) -> tuple[int, ...]:
        r"""The shape of the array."""
        return self._data.shape

    @property
    def size(self) -> int:
        r"""The total number of elements in the array."""
    ...
    def copy(self, *args: Any, **kwargs: Any) -> TBatchedArray:
    ...
    def empty_like(self, *args: Any, **kwargs: Any) -> TBatchedArray:
        ...
        Returns:
            A uninitialized batch with the same shape as the current
                batch.
    ...
    def full_like(self, *args: Any, **kwargs: Any) -> TBatchedArray:
        ...
        Returns:
            A batch filled with the scalar value, with the same shape
    ...
    def new_full(
        ...
        **kwargs: Any,
        ...
        Args:
            fill_value: Specifies the number to fill the batch with.
        ...
        Returns:
            A batch filled with the scalar value.
    ...
    def ones_like(self, *args: Any, **kwargs: Any) -> TBatchedArray:
        ...
        Returns:
            A batch filled with the scalar value ``1``, with the same
    ...
    def zeros_like(self, *args: Any, **kwargs: Any) -> TBatchedArray:
        ...
        Returns:
            A batch filled with the scalar value ``0``, with the same
                shape as the current batch.
    ...
    def astype(
        self, dtype: np.dtype | type[int] | type[float] | type[bool], *args: Any, **kwargs: Any
    ) -> TBatchedArray:
        ...
        Returns:
            A new batch with the data after dtype and/or device
                conversion.
    ...
    def eq(self, other: BatchedArray | ndarray | bool | int | float) -> TBatchedArray:
        ...
        Returns:
            A batch containing the element-wise equality.
    ...
    def ge(self, other: BatchedArray | ndarray | bool | int | float) -> TBatchedArray:
        ...
        Returns:
            A batch containing the element-wise comparison.
    ...
    def bool(self) -> TBatchedArray:
        ...
        Returns:
            The current batch to bool data type.
    ...
    def double(self) -> TBatchedArray:
        ...
        Returns:
            The current batch to double data type.
    ...
    def float(self) -> TBatchedArray:
        ...
        Returns:
            The current batch to float data type.
    ...
    def int(self) -> TBatchedArray:
        ...
        Returns:
            The current batch to int data type.
    ...
    def long(self) -> TBatchedArray:
        ...
        Returns:
            The current batch to long data type.
    ...
    @overload
    def cumsum(self, axis: int, *args: Any, **kwargs: Any) -> TBatchedArray:
        r"""See ``numpy.cumsum`` documentation."""

    def cumsum(self, axis: int | None, *args: Any, **kwargs: Any) -> TBatchedArray | ndarray:
        r"""Computes the cumulative sum of elements of the current batch
        in a given axis.
    ...
    def cumsum_(self, axis: int, *args: Any, **kwargs: Any) -> None:
        r"""Computes the cumulative sum of elements of the current batch
        in a given axis.
    ...
    def cumsum_along_batch_(self, *args: Any, **kwargs: Any) -> None:
        r"""Computes the cumulative sum of elements of the current batch
        in the batch axis.
    ...
    def logcumsumexp(self, axis: int) -> TBatchedArray:
        ...
        Returns:
            A batch with the cumulative summation of the exponentiation
                of elements of the current batch in a given axis.
    ...
    def logcumsumexp_along_batch(self) -> TBatchedArray:
        ...
        Returns:
            A batch with the cumulative summation of the exponentiation
                of elements of the current batch in the batch axis.
    ...
    def permute_along_axis(self, permutation: Sequence[int] | ndarray, axis: int) -> TBatchedArray:
        ...
        Args:
            permutation: Specifies the permutation to use on the data.
                The axis of the permutation input should be compatible
    ...
    def sort_along_batch(
        ...
        Args:
            ...
            stable: Makes the sorting routine stable, which guarantees
    ...
    def abs(self) -> TBatchedArray:
        ...
        Returns:
            A batch with the absolute value of each element.
    ...
    def clamp(
        ...
        Args:
            min: Specifies the lower bound. If ``min`` is ``None``,
                there is no lower bound.
            max: Specifies the upper bound. If ``max`` is ``None``,
                there is no upper bound.

        Returns:
            A batch with clamped values.
    ...
    def concatenate(
        ...
        Returns:
            A batch with the concatenated data in the given axis.
    ...
    def concatenate_along_batch(
        ...
        Returns:
            A batch with the concatenated data in the batch axis.
...
def implements(np_function: Callable) -> Callable:
    ...
    Args:
        np_function:  Specifies the numpy function to override.
...
def isneginf(x: BatchedArray) -> BatchedArray:
    r"""See ``numpy.isneginf`` documentation."""
    return x.isneginf()


@implements(np.isposinf)
def isposinf(x: BatchedArray) -> BatchedArray:
    r"""See ``numpy.isposinf`` documentation."""
    return x.isposinf()


@implements(np.sum)
def numpysum(input: BatchedArray, *args: Any, **kwargs: Any) -> ndarray:  # noqa: A002
    r"""See ``numpy.sum`` documentation.
