...
def test_batched_tensor_seq_max_global(data: torch.Tensor, max_value: bool | int | float) -> None:
...
def test_batched_tensor_seq_min_global(data: torch.Tensor, min_value: bool | int | float) -> None:
